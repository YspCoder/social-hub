...
<p>
  ...
  <img alt="186 adapter products" src="https://img.shields.io/badge/adapters-186-111827">
...
| Compile-time adapter registry | ✅ | 186 registered API products |
...
| README coverage for every adapter | ❌ | 185/186 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/186 adapter packages |
...
[Browse all 186 registered adapter products →](docs/adapter-catalog.md)
