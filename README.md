...
<p>
  ...
  <img alt="177 adapter products" src="https://img.shields.io/badge/adapters-177-111827">
...
| Compile-time adapter registry | ✅ | 177 registered API products |
...
| README coverage for every adapter | ❌ | 176/177 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/177 adapter packages |
...
[Browse all 177 registered adapter products →](docs/adapter-catalog.md)
