...
<p>
  ...
  <img alt="181 adapter products" src="https://img.shields.io/badge/adapters-181-111827">
...
| Compile-time adapter registry | ✅ | 181 registered API products |
...
| README coverage for every adapter | ❌ | 180/181 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/181 adapter packages |
...
[Browse all 181 registered adapter products →](docs/adapter-catalog.md)
