...
<p>
  ...
  <img alt="184 adapter products" src="https://img.shields.io/badge/adapters-184-111827">
...
| Compile-time adapter registry | ✅ | 184 registered API products |
...
| README coverage for every adapter | ❌ | 183/184 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/184 adapter packages |
...
[Browse all 184 registered adapter products →](docs/adapter-catalog.md)
