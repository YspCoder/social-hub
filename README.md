...
<p>
  ...
  <img alt="168 adapter products" src="https://img.shields.io/badge/adapters-168-111827">
...
<p><sub>Documentation baseline: 2026-08-25 (Asia/Shanghai)</sub></p>
...
| Compile-time adapter registry | ✅ | 168 registered API products |
...
| README coverage for every adapter | ❌ | 167/168 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/168 adapter packages |
...
[Browse all 168 registered adapter products →](docs/adapter-catalog.md)
