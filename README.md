...
<p>
  ...
  <img alt="188 adapter products" src="https://img.shields.io/badge/adapters-188-111827">
...
| Compile-time adapter registry | ✅ | 188 registered API products |
...
| README coverage for every adapter | ❌ | 187/188 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/188 adapter packages |
...
[Browse all 188 registered adapter products →](docs/adapter-catalog.md)
