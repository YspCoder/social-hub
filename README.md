...
<p>
  ...
  <img alt="180 adapter products" src="https://img.shields.io/badge/adapters-180-111827">
...
| Compile-time adapter registry | ✅ | 180 registered API products |
...
| README coverage for every adapter | ❌ | 179/180 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/180 adapter packages |
...
[Browse all 180 registered adapter products →](docs/adapter-catalog.md)
