...
<p>
  ...
  <img alt="179 adapter products" src="https://img.shields.io/badge/adapters-179-111827">
...
| Compile-time adapter registry | ✅ | 179 registered API products |
...
| README coverage for every adapter | ❌ | 178/179 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/179 adapter packages |
...
[Browse all 179 registered adapter products →](docs/adapter-catalog.md)
