...
<p>
  ...
  <img alt="178 adapter products" src="https://img.shields.io/badge/adapters-178-111827">
...
| Compile-time adapter registry | ✅ | 178 registered API products |
...
| README coverage for every adapter | ❌ | 177/178 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/178 adapter packages |
...
[Browse all 178 registered adapter products →](docs/adapter-catalog.md)
