...
<p>
  ...
  <img alt="187 adapter products" src="https://img.shields.io/badge/adapters-187-111827">
...
| Compile-time adapter registry | ✅ | 187 registered API products |
...
| README coverage for every adapter | ❌ | 186/187 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/187 adapter packages |
...
[Browse all 187 registered adapter products →](docs/adapter-catalog.md)
