...
<p>
  ...
  <img alt="171 adapter products" src="https://img.shields.io/badge/adapters-171-111827">
...
| Compile-time adapter registry | ✅ | 171 registered API products |
...
| README coverage for every adapter | ❌ | 170/171 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/171 adapter packages |
...
[Browse all 171 registered adapter products →](docs/adapter-catalog.md)
