...
<p>
  ...
  <img alt="190 adapter products" src="https://img.shields.io/badge/adapters-190-111827">
...
| Compile-time adapter registry | ✅ | 190 registered API products |
...
| README coverage for every adapter | ❌ | 189/190 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/190 adapter packages |
...
[Browse all 190 registered adapter products →](docs/adapter-catalog.md)
