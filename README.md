...
<p>
  ...
  <img alt="185 adapter products" src="https://img.shields.io/badge/adapters-185-111827">
...
| Compile-time adapter registry | ✅ | 185 registered API products |
...
| README coverage for every adapter | ❌ | 184/185 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/185 adapter packages |
...
[Browse all 185 registered adapter products →](docs/adapter-catalog.md)
