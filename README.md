...
<p>
  ...
  <img alt="176 adapter products" src="https://img.shields.io/badge/adapters-176-111827">
...
| Compile-time adapter registry | ✅ | 176 registered API products |
...
| README coverage for every adapter | ❌ | 175/176 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/176 adapter packages |
...
[Browse all 176 registered adapter products →](docs/adapter-catalog.md)
