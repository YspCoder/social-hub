...
<p>
  ...
  <img alt="189 adapter products" src="https://img.shields.io/badge/adapters-189-111827">
...
| Compile-time adapter registry | ✅ | 189 registered API products |
...
| README coverage for every adapter | ❌ | 188/189 adapter packages |
| Local test-file coverage for every adapter | ❌ | 104/189 adapter packages |
...
[Browse all 189 registered adapter products →](docs/adapter-catalog.md)
