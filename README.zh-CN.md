...
<p>
  ...
  <img alt="179 个适配器产品" src="https://img.shields.io/badge/adapters-179-111827">
...
| 编译期适配器注册 | ✅ | 179 个已注册 API 产品 |
| YAML/JSON 严格配置 | ✅ | 配置版本 `1`，未知字段会报错 |
| 运行时 Secret 引用 | ✅ | 内置 `env://`，支持自定义 resolver |
| 每个适配器都有 README | ❌ | 178/179 个适配器包 |
| 每个适配器都有本地测试文件 | ❌ | 104/179 个适配器包 |
...
[查看全部 179 个已注册适配器产品 →](docs/adapter-catalog.md)
