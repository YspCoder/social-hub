...
<p>
  ...
  <img alt="178 个适配器产品" src="https://img.shields.io/badge/adapters-178-111827">
...
| 编译期适配器注册 | ✅ | 178 个已注册 API 产品 |
| YAML/JSON 严格配置 | ✅ | 配置版本 `1`，未知字段会报错 |
| 运行时 Secret 引用 | ✅ | 内置 `env://`，支持自定义 resolver |
| 每个适配器都有 README | ❌ | 177/178 个适配器包 |
| 每个适配器都有本地测试文件 | ❌ | 104/178 个适配器包 |
...
[查看全部 178 个已注册适配器产品 →](docs/adapter-catalog.md)
