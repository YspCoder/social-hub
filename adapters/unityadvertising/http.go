...
func (client *Client) deleteJSON(ctx context.Context, operation, path string, options ...socialhub.CallOption) error {
	return withOperation(client.api.JSON(ctx, http.MethodDelete, path, nil, nil, nil, options...), operation)
}
