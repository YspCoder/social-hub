...
func decodeHTTPError(status int, header http.Header, body []byte) error {
	...
	return &socialhub.Error{
		Code: code, Class: class, Platform: "forem", Product: productName, HTTPStatus: status,
		PlatformCode: strconv.Itoa(firstPositive(response.Status, status)), PlatformMessage: boundedMessage(response.Error, 512),
...
func platformError(operation string, code socialhub.ErrorCode, class socialhub.ErrorClass, cause error) error {
	return &socialhub.Error{Code: code, Class: class, Platform: "forem", Product: productName, Op: operation, Cause: cause}
}

func invalidArgument(operation, message string) error {
	return &socialhub.Error{
		Code: socialhub.CodeInvalidArgument, Class: socialhub.ClassPermanent, Platform: "forem", Product: productName,
...
func unsupported(operation, message string) error {
	return &socialhub.Error{
		Code: socialhub.CodeUnsupported, Class: socialhub.ClassPermanent, Platform: "forem", Product: productName,
		Op: operation, PlatformMessage: message,
	}
}
