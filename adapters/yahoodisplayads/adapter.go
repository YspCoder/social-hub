// Package yahoodisplayads implements LINE Yahoo Display Ads API v20
...
const (
	adapterName      = "line-yahoo/display-ads-api-v20"
	platformName     = "line-yahoo"
	productName      = "display-ads-api"
	apiVersion       = "v20"
	defaultBaseURL   = "https://ads-display.yahooapis.jp/api/v20"
	defaultAuthURL   = "https://biz-oauth.yahoo.co.jp/oauth/v1/authorize"
	defaultTokenURL  = "https://biz-oauth.yahoo.co.jp/oauth/v1/token"
	documentationURL = "https://ads-developers.yahoo.co.jp/reference/ads-display-api/v20/"
	oauthScope       = "yahooads"
)

// AccountSettings binds one social-hub account to one Display Ads account.
...
// Adapter implements socialhub.Adapter for LINE Yahoo Display Ads API v20.
type Adapter struct {
	mu      sync.RWMutex
...
func (adapter *Adapter) Init(_ context.Context, config socialhub.AdapterConfig, options ...socialhub.Option) error {
	...
	for _, account := range config.Accounts {
		...
		if account.Webhook != (socialhub.WebhookConfig{}) {
			return invalidArgument("init", "webhook settings are not supported by Display Ads API")
		}
	}
...
func (adapter *Adapter) Client(ctx context.Context, accountID socialhub.AccountID, options ...socialhub.Option) (socialhub.Client, error) {
	...
	return &Client{
		accountID: accountID, advertiserAccountID: typed.AccountID, baseAccountID: baseAccountID,
