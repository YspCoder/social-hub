...
func (err *APIError) Error() string {
	if err == nil || err.Hub == nil {
		return "socialhub: google-ad-manager: platform_error"
	}
...
func classifyError(status int, platformStatus, reason string) (socialhub.ErrorCode, socialhub.ErrorClass) {
	...
	switch normalized {
	case "ratelimitexceeded", "quotaexceeded", "exceededquota", "reportjoblimit", "resourceexhausted":
...
func ownershipError(operation, resource string) error {
	return &socialhub.Error{Code: socialhub.CodePermissionDenied, Class: socialhub.ClassUserAction, Platform: platformName, Product: productName, Op: operation, PlatformMessage: resource + " is not owned by the configured network"}
}
