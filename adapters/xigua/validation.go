...
func validTitle(value string) bool {
	...
	return utf8.ValidString(value) && length >= 5 && length <= 30
}

func validSummary(value string) bool {
	return utf8.ValidString(value) && utf8.RuneCountInString(value) <= 400
}
...
func parseCursor(value string) (int64, error) {
	...
	if err != nil || parsed < 0 || strconv.FormatInt(parsed, 10) != value {
		return 0, invalidArgument("pagination", "cursor must be a canonical non-negative integer returned by Xigua")
	}
	return parsed, nil
}
