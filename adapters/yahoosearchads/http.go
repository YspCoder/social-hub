...
func postPage[T any](
	...
	maximum int32,
	entity func(rawValue) json.RawMessage,
	...
	return Page[T]{
		Items: items, TotalNumEntries: wire.TotalNumEntries,
		StartIndex: page.StartIndex, NumberResults: page.NumberResults, RID: rid,
	}, nil
}

func postMutation[T any](
	ctx context.Context,
	client *Client,
	operation, path string,
	input any,
...
func keywordEntity(value rawValue) json.RawMessage  { return value.AdGroupCriterion }
