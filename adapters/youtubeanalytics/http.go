...
func (client *Client) postJSON(ctx context.Context, operation, path string, query url.Values, input, output any, options ...socialhub.CallOption) (transport.ResponseMetadata, error) {
	return client.jsonRequest(ctx, http.MethodPost, operation, path, query, input, output, options...)
}
...
func (client *Client) putJSON(ctx context.Context, operation, path string, query url.Values, input, output any, options ...socialhub.CallOption) error {
	_, err := client.jsonRequest(ctx, http.MethodPut, operation, path, query, input, output, options...)
	return err
}
