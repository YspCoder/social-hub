...
func classifyBusinessCode(code string) (socialhub.ErrorCode, socialhub.ErrorClass) {
	switch code {
	case "400", "40001", "40003", "40005", "422":
		return socialhub.CodeInvalidArgument, socialhub.ClassPermanent
	case "401", "40101", "40103":
		return socialhub.CodeUnauthenticated, socialhub.ClassUserAction
	case "403", "40301", "40303":
...
func outcomeUnknownError(operation string, cause error) error {
	...
	return &socialhub.Error{
		...
		PlatformMessage: "Spotlight mutation outcome is unknown; reconcile provider state before retrying",
		RequestID:       requestID, Cause: errors.Join(ErrOutcomeUnknown, sanitizeCause(cause)),
	}
}

func partialMutationError(operation, requestID string) error {
	return &socialhub.Error{
		Code: socialhub.CodeConflict, Class: socialhub.ClassUserAction,
		Platform: platformName, Product: productName, Op: operation,
		PlatformMessage: "Spotlight acknowledged only part of the requested mutation",
		RequestID:       requestID, Cause: ErrPartialMutation,
	}
}
